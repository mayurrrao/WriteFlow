...
const ImproveSkillsCard = () => {
    ...
    return (
        ...
        >
            ...
            <div
                className={`absolute top-10 left-0.5 w-24 h-24 bg-green-100 rounded-full blur-xl transition-transform duration-700 ${
            ...
            <div className="flex-1 text-left">
                <div className="flex items-center gap-3">
                    <FaLightbulb
                        className={`text-3xl transition-all duration-300 ${
                            isHovered ? "text-green-700 scale-110" : "text-green-600"
                        }`}
                    />
                ...
                >
                    <p className="text-md text-gray-700">How blogging improves your skills:</p>
            ...
            <div className="relative flex-1 flex justify-end items-center space-x-4">
                <div
                    className={`w-20 h-20 bg-gray-100 rounded-lg shadow-sm transition-all duration-500 ${
                        isHovered ? "translate-y-2 scale-105 shadow-md" : "scale-100"
                    }`}
                ></div>
                <div
                    className={`w-16 h-16 bg-green-100 rounded-lg shadow-sm transition-all duration-500 ${
                        isHovered ? "-translate-y-2 scale-110 shadow-md" : "scale-100"
                    }`}
                ></div>
                {/* Extra Floating Element for more interactivity */}
                <div
                    className={`w-12 h-12 bg-gray-200 rounded-full transition-transform duration-500 ${
...
export default ImproveSkillsCard;
