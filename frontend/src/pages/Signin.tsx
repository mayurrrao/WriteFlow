    ...
    <div className="relative min-h-screen bg-white overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
          ...
          <div className="flex items-center justify-center bg-white text-gray-900 p-6 md:p-10 lg:p-12 w-full">
            <Auth2 />
          </div>
          {/* Quote Section - Visible only on large screens */}
          <div className="hidden lg:flex items-center justify-center p-6 bg-gray-50">
            <QuoteSignin />
          </div>
        </div>
      </div>
